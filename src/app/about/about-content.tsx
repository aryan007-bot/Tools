...
export function AboutContent() {
  ...
  return (
    <div className="bg-[#FAF9F5] text-gray-900 font-sans antialiased selection:bg-purple-500/30 selection:text-gray-900 min-h-screen pt-28 relative overflow-hidden">
      ...
      <section className="relative my-0 sm:my-16 flex h-[120px] sm:h-[220px] w-full select-none items-center justify-center overflow-hidden bg-[#FAF9F5]">
      ...
      <section className="relative mx-auto max-w-6xl px-6 py-24 border-t border-gray-200 z-10">
        <div className="mb-16 text-center">
          <div className="mb-4">
            <div className="inline-flex items-center gap-2.5 rounded-full border border-gray-200 bg-white/80 px-3.5 py-2 shadow-sm backdrop-blur-sm">
              <span className="font-sans text-[11px] font-bold uppercase tracking-wider text-[#8B5CF6]">Our Process</span>
            </div>
          </div>
          <h2 className="font-medium text-gray-900 text-3xl sm:text-4xl lg:text-5xl font-serif">
            From Blueprint to Production
          </h2>
          <p className="mx-auto mt-3 text-lg font-light text-gray-600 max-w-xl font-sans">
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-1 items-stretch gap-8 lg:grid-cols-12">
          ...
          <div className="flex flex-col gap-4 lg:col-span-6">
            {[
              ...
              <div 
                key={step.num}
                className="flex items-center justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.02)] transition-all hover:border-purple-500/25 duration-200 group cursor-default"
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-900 font-sans font-bold text-white group-hover:bg-purple-600 transition-colors">
                    {step.num}
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm font-sans">{step.title}</h4>
                    <p className="mt-0.5 text-xs text-gray-500 font-sans">{step.desc}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="lg:col-span-6">
            <div 
              className="relative flex h-full flex-col justify-between overflow-hidden rounded-[32px] border border-gray-800 bg-[#0f1115] p-8 text-white shadow-xl sm:p-10"
              style={{
                background: "radial-gradient(circle at bottom right, rgba(139, 92, 246, 0.45) 0%, transparent 65%), #0c0c0c"
              }}
            >
              <div className="relative z-10 space-y-4">
                <h3 className="text-white font-medium leading-tight tracking-tight text-3xl sm:text-4xl font-serif">
                  Project in Mind?<br />
                  <span className="text-purple-400">Get in Touch</span>
                </h3>
                <p className="max-w-sm text-sm leading-relaxed text-gray-400 font-sans font-light">
              ...
              <div className="relative z-10 mt-10">
                <button
                  ...
                  className="group flex w-full cursor-pointer select-none items-center justify-center gap-2 rounded-full border border-gray-805 bg-[#1b1b1b]/80 py-3.5 text-xs font-bold uppercase tracking-widest text-white transition-all duration-300 hover:border-purple-500/30 hover:bg-[#8B5CF6]/20 font-sans"
                >
                  Get Started
      ...
      <section className="relative flex w-full flex-col items-center bg-[#FAF9F5] pb-24 pt-10 sm:pb-32 sm:pt-14 border-t border-gray-200 z-10" style={{ backgroundImage: "radial-gradient(circle, rgba(139, 92, 246, 0.06) 1.2px, transparent 1.2px)", backgroundSize: "30px 30px" }}>
        <div className="relative z-10 flex w-full max-w-6xl flex-col items-center px-6">
          <div className="relative mb-16 flex flex-col items-center text-center">
            ...
            <h2 className="mb-4 select-none font-medium leading-tight text-gray-900 text-3xl sm:text-4xl lg:text-5xl font-serif">
              Let&apos;s build something bold
            </h2>
            <p className="text-lg leading-relaxed text-gray-500 font-sans font-light max-w-xl">
          ...
          <div 
            id="contact-form" 
            className="relative flex w-full flex-col items-stretch justify-between gap-12 overflow-hidden rounded-[32px] border border-gray-800 bg-[#0f1115] p-8 text-white shadow-[0_20px_50px_rgba(0,0,0,0.3)] sm:p-12 md:p-16 lg:flex-row scroll-mt-24"
          >
            ...
            <div className="z-10 flex flex-col justify-between space-y-8 lg:w-[45%]">
              <div className="space-y-4 text-left">
                <h2 className="font-medium leading-tight text-white text-3xl sm:text-4xl lg:text-5xl font-serif">
              ...
              <div className="hidden lg:block text-left">
                <span className="block font-sans text-[10px] font-semibold uppercase tracking-wider text-gray-500">ToolStack Studio - 2026</span>
              </div>
            </div>
            ...
            <div className="z-10 flex flex-col justify-between space-y-6 lg:w-[50%]">
              <form onSubmit={handleSubmit} className="space-y-6 text-left w-full">
                <div className="space-y-1">
                  <label className="font-sans text-[11px] font-bold uppercase tracking-wider text-gray-400">Your Name</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full border-b border-gray-800 bg-transparent py-3 text-sm text-white placeholder-gray-550 transition-colors focus:border-purple-400 focus:outline-none font-sans font-light"
                  />
                </div>
                <div className="space-y-1">
                  <label className="font-sans text-[11px] font-bold uppercase tracking-wider text-gray-400">Your Email</label>
                  <input
                    type="email"
                    required
                ...
                <div className="space-y-1">
                  <label className="font-sans text-[11px] font-bold uppercase tracking-wider text-gray-400">Project Description</label>
                  <textarea
                    required
                    ...
                    className="w-full resize-none border-b border-gray-800 bg-transparent py-3 text-sm text-white placeholder-gray-550 transition-colors focus:border-purple-400 focus:outline-none font-sans font-light"
                  />
                </div>
